        ...
        <div className="fixed inset-0 z-50 flex justify-center items-center bg-black bg-opacity-50">
            <div className="bg-white p-2 rounded-md shadow-md w-11/12 max-h-[95%] overflow-auto relative text-pretty tablet:max-w-[50rem]">
                ...
                <div className="flex flex-col items-center overflow-auto">
                    <div className="relative mx-4 mt-4 overflow-hidden text-white shadow-lg rounded-xl bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40 h-44 w-72">
                    ...
                    <div>
                        <p><strong>Event Type:</strong> {type[0]}</p>
                        <p><strong>Event Classification:</strong> {type[1]}</p>
                        <p><strong>Department(s):</strong> {event.department.join(', ')}</p>
                    </div>
                    <button
